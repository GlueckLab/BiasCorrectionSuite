...
%macro BiasCorrectionTool01( seed, errorCode, numberOfrealizations, sampleSize, tolerance, maxIterations, meanOfTest1ScoresCases, meanOfTest2ScoresCases, stdOfTest1ScoresCases, stdOfTest2ScoresCases, correlationT1T2ForCases, meanOfTest1ScoresNonCases,
				...
				do vectorRow = 1 to ncat by 1;
					...
					do rep = 1 to &numberOfrealizations;
						...
						if numberCases < 2 | numberNonCases < 2 then do;
							...
							/* exampleMatrix = id || disease || ss || t1score || t2score; */

							use out01.example1;
							read all var _ALL_ into exampleMatrix;
