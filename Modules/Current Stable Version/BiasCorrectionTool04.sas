...
nathInAllQuadrants: checks if the quadrants are empty and set the appropriate error codes.
...
%BiasCorrectionTool(-99999, 50000, .000001, 500, { 65 59 } ); 
...
%macro BiasCorrectionTool04( errorCode, sampleSize, tolerance, maxIterations, 
                          cutOffT1T2 ) / store source; 
