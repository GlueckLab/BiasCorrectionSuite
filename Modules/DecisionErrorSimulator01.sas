...
%macro DecisionErrorSimulator01( seed, errorCode, nrep, sampsize, tolerance, maxIterations, tmuc1, tmuc2, tsigc1, tsigc2, trhoc, tmun1,
...
/* **************************** Step 1 in SummaryDecisionErrorSimulator01 document ************************************** */

	*create empty file with preferred characteristics;
	data out01.results ( compress = no );


/* **************************** Step 2 in SummaryDecisionErrorSimulator01 document ************************************** */
	...
	proc iml worksize = 3000 symsize = 6000;	
		...
		start main;    
			...
			print 'start with the main module';
...
/***********************************************************************************************************/
			...
			start setErrorCodes;
				...
				else if ( outcome1 ^= 0 & outcome2 ^= 0 & outcome3 ^= 0 & outcome4 ^= 0 & flag = 5) then do;
			...
			print 'finished defining the setErrorCodes module.';

/***********************************************************************************************************/
			start emptyQuadrants;
			
				print 'Entering empty quadrants module';
...
/* **************************** Step 15(b) in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 15(c) in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 15(c) in SummaryDecisionErrorSimulator01 document ************************************** */
				...
				print 'Exiting the emptyQuadrants module';
			finish;
			print 'finished defining emptyQuadrants module';
...
/***********************************************************************************************************/
			start completeAnalysis;
				...
				print 'Entering completeAnalysis module';
...
/* **********************************Step 9(b, c) in SummaryDecisionErrorSimulator01 document ********************** */
			...
			finish;
				print 'finished defining completeAnalysis module';
...
/***********************************************************************************************************/
			start biasCorrectionAnalysis;
				...
				print 'Entering biasCorrectionAnalysis module';
...
/* **************************** Step 15(d) in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 15(e) in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 15(f) in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 15(g, h) in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 15(i, j, k) in SummaryDecisionErrorSimulator01 document ************************************** */
			...
			finish;
				print 'finished defining biasCorrectionAnalysis module';
			
/***********************************************************************************************************/

			start decisionError;

				print 'entering bias correction module';
...
/* **************************** Step 3 in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 4 in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 5 in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 5(b) in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** Step 6 in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **************************** NEW STEP ************************************** */
							...
							/* cname = {"id" "ObservedDiseaseStatus" "Thresholds" "Test1Score" "Test2Score"}; */

							/* create sampleDataSet from matrix [colname=cname]; */
...
/* **************************** Step 8 in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **********************************Step 9(a) in SummaryDecisionErrorSimulator01 document ********************** */

/* **************************** Call the Complete Analysis module ************************************** */


								run completeAnalysis;	


/* **************************** Step 13 in SummaryDecisionErrorSimulator01 document ************************************** */
...
/* **********************************Observed Analysis (Step 11 in SummaryDecisionErrorSimulator01 document) ********************** */
...
/***********************************************************************************************************/
			...
			print 'finished defining biasCorrection module.';
				
			print 'start running the bias correction module';
