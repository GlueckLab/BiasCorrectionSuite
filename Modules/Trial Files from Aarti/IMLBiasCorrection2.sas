...
%macro IMLBiasCorrection2( seed, errorCode, nrep, sampsize, tolerance, maxIterations, tmuc1, tmuc2, tsigc1, tsigc2, trhoc, tmun1,
						...
						if numberCases < 2 | numberNonCases < 2 then do;
							...
							if ( numberObsCases < 2 | numberObsNonCases < 2 ) then do;
								...
								if numberObsCasesQ123 < 2 then do;
									print 'inside numberObsCasesQ123';
									empty123 = 1;
									empty1 = 1;
									empty2 = 1;
									empty3 = 1;
								...
								if ( outcome1 ^= 0 &
									...
									if ( correctedNumberCasesNonCases[ , 1 ] > &sampSize |
									   ...
									   print 'correctedNumberCasesNonCases';
