...
%macro IMLBiasCorrectionDecisionError( seed, errorCode, nrep, sampsize, tolerance, maxIterations, tmuc1, tmuc2, tsigc1, tsigc2, trhoc, tmun1,
	...
	*create empty file with preferred characteristics;
	data out01.results ( compress = no );
		...
		rename  empty1 = emptyQuad1
			    empty2 = emptyQuad2
			    empty3 = emptyQuad3
			    empty4 = emptyQuad4
			    tmuc1 = meanOfTest1ScoresCases
			    tmuc2 = meanOfTest2ScoresCases
			    tmun1 = meanOfTest1ScoresNonCases
				tmun2 = meanOfTest2ScoresNonCases
				tsigc1 = stdOfTest1ScoresCases
				tsigc2 = stdOfTest2ScoresCases
				tsign1 = stdOfTest1ScoresNonCases
				tsign2 = stdOfTest2ScoresNonCases
				quadrantContainingMLECases = quadrantMLECases
				quadrantContainingMLENonCases = quadrantMLENonCases
				outcome1 = outcomeNathQuad1
				outcome2 = outcomeNathQuad2
				outcome3 = outcomeNathQuad3
				outcome4 = outcomeNathQuad4 ;
