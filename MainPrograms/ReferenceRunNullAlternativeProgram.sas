...
%CommonMain( BiasCorrectionTuneUp, ReferenceRun, IMLBiasCorrectionLowPowerPrevalence ); 

proc printto log = "&OUTPUT_FILE..log";
run;

%IMLBiasCorrection( 1066, -99999, 3, 50000, .000001, 500, 61.1, 62.5, 1, 5, .1, 60, 58, 1, 5, .1, .01, { 65 59 }, .1, diseasePrevalence, vector = ( { .01, .025, .05, .075, .1, .125, .15, .175, .2, .225, .25 } ) );
