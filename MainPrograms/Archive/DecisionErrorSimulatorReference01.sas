...
/*Alternative*/
%IMLBiasCorrection( 1066, -99999, 100, 50000, .000001, 500, 61.1, 62.5, 1, 5, .1, 60, 58, 1, 5, .1, .01, { 65 59 }, .1, diseasePrevalence, vector = ( { .01 } ) );
...
%IMLBiasCorrection( 1066, -99999, 100, 50000, .000001, 500, 61.1, 61.1, 1, 1, .1, 60, 60, 1, 1, .1, .01, { 65 59 }, .1, diseasePrevalence, vector = ( { .01 } ) );
